...
const Header = ({}: Props) => {
  return (
    <div  id='top'>
      ...
      <header className="hidden sticky top-0 p-5 py-2 md:flex md:flex-row items-center justify-between md:justify-evenly mx-auto z-20 bg-white/50 xl:items-center min-w-[640]">
        <motion.div
          initial={{
            y: -200,
            opacity: 0,
